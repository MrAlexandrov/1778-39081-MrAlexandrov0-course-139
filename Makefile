...
push.base:
	docker tag fruits/service-base registry.yandex-academy.ru/school/2023-06/backend/python/homeworks/hw3_dbindex/fruits/service-base:latest
	docker push registry.yandex-academy.ru/school/2023-06/backend/python/homeworks/hw3_dbindex/fruits/service-base:latest
...
push.postgres:
	docker tag fruits/store registry.yandex-academy.ru/school/2023-06/backend/python/homeworks/hw3_dbindex/fruits/store:latest
	docker push registry.yandex-academy.ru/school/2023-06/backend/python/homeworks/hw3_dbindex/fruits/store:latest

run.postgres:
	docker run --name store -e POSTGRES_USER=user -e POSTGRES_PASSWORD=random -e POSTGRES_DB=homework -p 5432:5432 registry.yandex-academy.ru/school/2023-06/backend/python/homeworks/hw3_dbindex/fruits/store
